...
import { WordText } from "laya/utils/WordText";
...
export class JsonBinWrite {
	...
	private _writeStrOrWordText(keyMap: SaveKeyMap, key: any, value: any, out, isWordText: boolean): void {
	...
	private _writeString(keyMap: SaveKeyMap, value: any, out): void {
		var keyNum: number = keyMap.keys[value];
		if (!keyNum) {
			keyNum = keyMap.keys[value] = keyMap.keyIndex;
			keyMap.strs.push(value, 0);
