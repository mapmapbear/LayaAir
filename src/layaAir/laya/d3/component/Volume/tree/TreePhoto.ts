...
export class TreePhoto {
    ...
    constructor(tr: TreeResource) {
        ...
        //创建贴图
        this._texture = new RenderTexture(2048, 2048,
            RenderTargetFormat.R8G8B8A8, RenderTargetFormat.DEPTHSTENCIL_24_8, false, 1, false, true);
        ...
        //创建相机
        this._camera = new Camera(0, 0.1, 200);
        this._camera.name = "TreePhotoCamera";
        this._camera.clearColor = new Color(0, 0, 0, 0);
        this._camera.aspectRatio = 1;
        this._camera.orthographic = true;
        this._camera.transform.localPositionZ = 10;

        //创建场景
        this._scene = new Scene3D();
        this._scene.name = "TreePhotoScene";
        ...
        this._ta.tree.lod = 0;
        this._ta.tree.dist = 1;
        this._ta.updateBoundBox();
    }
    ...
    snap() {
        ...
        Camera.drawRenderTextureByScene(this._camera, this._scene, this._texture);
        Laya.stage.removeChild(this._scene);
        this._tr.material.setWind(this._tr.cfg.wind);

        Functions.saveDataToFile(Functions.rt2Data(this._texture), "treePhoto.png");
